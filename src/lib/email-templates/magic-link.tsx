    ...
    <Body style={main}>
      <Container style={container}>
        <Section style={card}>
          ...
          <Text style={text}>
            Clique no botão abaixo para entrar na plataforma. Por segurança, o link expira em pouco
            tempo.
          </Text>
          ...
          <Hr style={hr} />
          <Text style={footer}>Se você não pediu este link, é só ignorar este e-mail.</Text>
          <Text style={footer}>
