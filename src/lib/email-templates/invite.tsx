    ...
    <Body style={main}>
      <Container style={container}>
        <Section style={card}>
          ...
          <Text style={text}>
            Olá! Você foi convidado para fazer parte de uma equipe no ConciergeIA — a plataforma que
            organiza check-ins, check-outs e o atendimento aos hóspedes.
          </Text>
          <Text style={text}>
          ...
          <Section style={steps}>
            ...
            <Text style={step}>3. Aceite o convite da equipe que aparece na primeira tela.</Text>
          </Section>

          <Hr style={hr} />
          <Text style={footer}>
            O link expira em alguns dias por segurança. Se você não esperava este convite, pode
            ignorar este e-mail com tranquilidade.
          </Text>
          <Text style={footer}>
