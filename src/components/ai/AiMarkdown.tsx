    ...
    <div className="[&>*:first-child]:mt-0 [&>*:last-child]:mb-0">
      <ReactMarkdown
        ...
        components={{
          ...
          /*
           * Texto na MESMA linha do marcador (17/09/2026, print do cliente: o
           * bullet ficava sozinho e o "**Zeppelin Old Bar:** …" descia para a
           * linha de baixo). Quando os itens vêm separados por linha em branco,
           * o Markdown vira "lista solta": cada item é `\n<p>…</p>\n`. Com o
           * `whitespace-pre-line` do item, aquele `\n` solto antes do parágrafo
           * era desenhado como uma linha vazia ao lado do bullet. Os textos
           * só de espaço entre blocos são descartados, e o primeiro parágrafo
           * do item perde a margem de cima para alinhar com o marcador.
           */
          li: ({ node, children: itemChildren, ...props }) => (
            <li
              {...props}
              className="whitespace-pre-line leading-relaxed [&>p:first-child]:mt-0 [&>p:last-child]:mb-0"
            >
              {Children.toArray(itemChildren).filter(
