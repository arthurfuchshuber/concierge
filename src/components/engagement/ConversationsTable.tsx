              ...
              {conversations.map((c) => (
                ...
                >
                  <td className="px-4 py-3">
                    <div className="font-medium truncate max-w-[160px]" title={c.guestName}>
                      {c.guestName}
                    </div>
                    {c.phone && (
                  ...
                  <td
                    className="px-4 py-3 text-xs text-muted-foreground truncate max-w-[160px] hidden md:table-cell"
