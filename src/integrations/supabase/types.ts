...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      permission_audit: {
        Row: {
          ...
          id: string;
          metadata: Json | null;
          new_access_level: Database["public"]["Enums"]["permission_access_level"] | null;
          permission_node_id: string | null;
          previous_access_level: Database["public"]["Enums"]["permission_access_level"] | null;
          scope_id: string | null;
    ...
    Enums: {
      ...
      permission_migration_mode: "legacy" | "monitoring" | "enforced" | "completed";
      permission_node_type: "PAGE" | "SUBPAGE" | "TAB" | "RESOURCE" | "FIELD" | "SECTION";
      permission_scope_type: "GLOBAL" | "TENANT" | "CLIENT" | "PROPERTY" | "RECORD";
      permission_system_role: "OWNER" | "SYSTEM" | "ADMIN_SAAS" | "CRON" | "INTEGRATION";
