    ...
    <div className="min-h-screen bg-background text-foreground">
      <div className="max-w-3xl mx-auto px-5 py-12">
        ...
        <section className="mt-8 space-y-4 text-sm leading-relaxed">
          ...
          <p>
            <strong>ConciergeIA</strong> é o nome legal do prestador responsável por este serviço e
            atua como controlador dos dados pessoais coletados, em conformidade com a LGPD (Lei
            Geral de Proteção de Dados). Contato: <strong>sigma@anfitriaosigma.com.br</strong>.
          </p>
          ...
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li>
              <strong>Conteúdo do guia:</strong> informações dos imóveis, fotos, recomendações,
              contatos.
            </li>
            <li>
              <strong>Uso e telemetria:</strong> logs de acesso, IP, identificadores de dispositivo,
          ...
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li>
              Cobrança, gestão da assinatura e tratamento de impostos (obrigação legal, via Paddle).
            </li>
          ...
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li>
              <strong>Paddle.com</strong> — Merchant of Record para venda, gestão de assinaturas,
              pagamentos, tributos e emissão de notas.
            </li>
            <li>
          ...
          <p>
            ...
            legais. Após esse período, dados são deletados ou anonimizados.
          </p>

          <h2 className="font-display text-2xl mt-6">6. Seus direitos</h2>
          <p>
            Você pode solicitar a qualquer momento: acesso, correção, exclusão, portabilidade,
            restrição, oposição ao tratamento e revogação de consentimento. Atendemos solicitações
            em até 15 dias.
          </p>

          <h2 className="font-display text-2xl mt-6">7. Segurança</h2>
          <p>
            Aplicamos medidas técnicas e organizacionais adequadas: criptografia em trânsito e em
            repouso, controle de acesso, monitoramento contínuo.
          </p>

          <h2 className="font-display text-2xl mt-6">8. Cookies</h2>
          <p>
            Usamos cookies essenciais para autenticação e funcionamento do serviço. Cookies
            opcionais (analytics) só são ativados com seu consentimento.
          </p>
