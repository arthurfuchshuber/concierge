...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "SigmaGuide — Guia digital para hospedagem" },
      ...
      { name: "twitter:title", content: "SigmaGuide — Guia digital para hospedagem" },
      ...
      { property: "og:site_name", content: "SigmaGuide" },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:ital,wght@0,400;0,500;0,600;0,700;0,800;1,400;1,500&family=DM+Serif+Display:ital@0;1&family=Cormorant+Garamond:ital,wght@0,400;0,500;0,600;1,400;1,500&family=Inter:wght@300;400;500;600;700&family=JetBrains+Mono:wght@400;500&display=swap",
      },
    ],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Organization",
          name: "SigmaGuide",
          url: "https://guiadigital.anfitriaosigma.com.br",
          logo: "https://guiadigital.anfitriaosigma.com.br/favicon.ico",
        }),
      },
    ],
  }),
