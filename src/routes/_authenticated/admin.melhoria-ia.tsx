...
import { Sparkles, Loader2, Globe2, GitBranch, Bot, Wand2, ArrowUpRight, Check, X, Plus } from "lucide-react";
...
export const Route = createFileRoute("/_authenticated/admin/melhoria-ia")({
  head: () => ({
    meta: [
      { title: "Melhoria da IA — Inteligência global do ConciergeIA" },
      {
        name: "description",
        content:
          "Painel da plataforma: inteligência global, pipeline de aprendizado, evolução dos agentes e dos prompts do ConciergeIA.",
      },
      { property: "og:title", content: "Melhoria da IA — ConciergeIA" },
      { property: "og:description", content: "Governança da inteligência global e evolução dos agentes." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
    ],
  }),
  component: AiImprovementPage,
});
    ...
    <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 py-6 space-y-6">
      <header className="space-y-1">
        <h1 className="font-display text-2xl sm:text-3xl flex items-center gap-2">
          <Sparkles className="size-6 text-primary" /> Melhoria da IA
        </h1>
