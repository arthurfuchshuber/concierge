  ...
  return (
    <div className="min-h-screen">
      <div className="px-6 lg:px-10 pt-8 lg:pt-10 pb-2 max-w-7xl mx-auto w-full">
        <h1 className="font-display text-3xl md:text-4xl tracking-tight">Integrações</h1>
        <p className="text-sm text-muted-foreground mt-1">
          Conecte serviços externos à sua operação.
        </p>
      </div>

      <div className="px-6 lg:px-10 max-w-7xl mx-auto w-full pt-6 pb-16 space-y-5">
      ...
      <Dialog open={openKey === "whatsapp"} onOpenChange={(o) => !o && setOpenKey(null)}>
        <DialogContent className="max-w-3xl max-h-[85vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle className="font-display text-2xl">WhatsApp Business</DialogTitle>
          </DialogHeader>
