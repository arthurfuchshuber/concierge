...
export const Route = createFileRoute("/auth")({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Acesse o ConciergeIA e automatize o atendimento aos seus hóspedes com IA.",
      },
        ...
        <aside className="hidden lg:flex flex-col gap-6 pr-8">
            ...
            <div className="mt-6 rounded-2xl bg-white/10 backdrop-blur p-4 border border-white/20 space-y-2.5">
              ...
              <div className="flex items-start gap-2">
                ...
                <div className="bg-black/40 text-white text-[13px] rounded-2xl rounded-bl-sm px-3 py-2 max-w-[85%]">
                  Claro! O wifi é <b>CasaVerão-2G</b> e a senha <b>bemvindo2026</b>. Precisa de mais
                  alguma coisa? 🌊
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-3 gap-3">
            {[
              ...
              <div
                key={f.label}
                className="rounded-2xl bg-white p-4 border border-black/5 shadow-sm"
              >
