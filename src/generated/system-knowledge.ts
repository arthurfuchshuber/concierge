...
export const SYSTEM_KNOWLEDGE: GeneratedSystemDoc[] = [
  ...
  },
  {
    ...
    content:
      "Caminho no sistema: /admin/dashboard/limpeza\n\nHistórico e custos das limpezas realizadas.",
